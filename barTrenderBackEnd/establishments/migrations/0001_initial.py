    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=establishments.models.tags_upload_to)),
            ],
        ),
        migrations.CreateModel(
            name='Establishment',
            fields=[
                ...
                ('street_text', models.CharField(max_length=50)),
                ('number_text', models.CharField(max_length=5)),
                ('locality_text', models.CharField(max_length=50)),
                ('image', models.ImageField(blank=True, null=True, upload_to=establishments.models.establishments_upload_to)),
