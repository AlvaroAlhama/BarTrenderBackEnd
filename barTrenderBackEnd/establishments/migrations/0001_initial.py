# Generated by Django 3.1.4 on 2021-03-20 12:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(to='establishments.Tag')),
            ],
        ),
        migrations.CreateModel(
            name='Discount',
            fields=[
                ...
                ('clients_id', models.ManyToManyField(blank=True, null=True, to='authentication.Client')),
